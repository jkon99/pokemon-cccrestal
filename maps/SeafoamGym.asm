...
SeafoamGym_MapEvents:
	...
	;object_event 8, 8, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 3, FirebreatherDick, EVENT_BEAT_FIREBREATHER_DICK ; was causing game to crash/go to antipiracy?
