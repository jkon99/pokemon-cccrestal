...
; Unused: next 48 events
	const EVENT_FOUGHT_MEWTWO ;new
	const EVENT_FOUGHT_MEW ;new
	const EVENT_FOUGHT_ARTICUNO ; new
	const EVENT_FOUGHT_ZAPDOS ; new
	const EVENT_FOUGHT_MOLTRES ; new
	const EVENT_ROUTE_47_RARE_CANDY ; new
	const EVENT_ROUTE_47_PSYCHIC ;new
	const EVENT_TEMP ; new
	const EVENT_BEAT_LASS_STELLA ; new
	const EVENT_BEAT_SAILOR_ARNOLD ; new
	const EVENT_GOT_TM09_PSYCHUP ;new
	const EVENT_BEAT_COOLTRAINERQUINN2 ;new
	const EVENT_BEAT_COOLTRAINERKEVIN2 ; new
	const EVENT_BEAT_DEVELOPER_JON ; new ; CCCE beat trainer flags
	const EVENT_BEAT_FRONTRUNNER_ALEX ; new
	const EVENT_BEAT_FRONTRUNNER_ASH ; new
	const EVENT_BEAT_FRONTRUNNER_CONNOR ; new
	const EVENT_BEAT_FRONTRUNNER_FRANCIS ; new
	const EVENT_BEAT_FRONTRUNNER_GENNA ; new
	const EVENT_BEAT_FRONTRUNNER_LEX  ; new
	const EVENT_BEAT_FRONTRUNNER_NAHOM  ; new
	const EVENT_BEAT_FRONTRUNNER_NANDO ; new
	const EVENT_BEAT_FRONTRUNNER_QASIM ; new
	const EVENT_BEAT_FRONTRUNNER_QUINN ; new
	const EVENT_BEAT_FRONTRUNNER_TJ ; new
	const EVENT_GOT_TM_THUNDER ; new
	const EVENT_GOT_TM_RAIN_DANCE ; new
	const EVENT_GOT_TM_SUNNY_DAY ; new
	const EVENT_GOT_TM_DREAM_EATER ; new
	const EVENT_GOT_TM_SANDSTORM ; new
	;add gym leader gifts, more events etc
	const_next 2048
