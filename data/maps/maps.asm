...
MapGroup_Dungeons:
	...
	map VictoryRoad, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE ; old legends cave spot below
...
MapGroup_Cinnabar:
	...
	map SeafoamGym, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_SEAFOAM_ISLANDS, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map CeruleanCave1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS ;new
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS ;new
	assert_table_length NUM_CERULEAN_MAPS ;fix +2
...
MapGroup_Silver:
	...
	map Route28SteelWingHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_27, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; swapped landmark with route 27
	map LegendsCave,	TILESET_CAVE, CAVE, LANDMARK_LEGENDS_CAVE, MUSIC_CERULEAN_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE ; new
...
MapGroup_Cianwood:
	...
	map CianwoodCave, TILESET_CAVE, CAVE, LANDMARK_ROUTE_47, MUSIC_ROUTE_47, TRUE, PALETTE_DAY, FISHGROUP_SHORE ; new
	map Route47, TILESET_JOHTO_MODERN, ROUTE, LANDMARK_ROUTE_47, MUSIC_ROUTE_47, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH ; new
	assert_table_length NUM_CIANWOOD_MAPS ; fix+2
...
MapGroup_NewBark:
	...
	map Route27SandstormHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_28, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE ; change landmark from route 28
