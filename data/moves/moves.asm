...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move RAZOR_WIND,   EFFECT_RAZOR_WIND,         90, NORMAL,        90, 10,   0
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,       100, 30,   0
	move CUT,          EFFECT_NORMAL_HIT,         60, BUG,       	100, 20,   0
	...
	move VINE_WHIP,    EFFECT_NORMAL_HIT,         40, GRASS,        100, 15,   0
	...
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          20, BUG,           95, 20,   0
	...
	move SUBMISSION,   EFFECT_RECOIL_HIT,         120, FIGHTING,    100, 15,   0
	...
	move PETAL_DANCE,  EFFECT_RAMPAGE,           100, GRASS,        100, 20,   0
	...
	move ROCK_THROW,   EFFECT_NORMAL_HIT,         55, ROCK,          90, 15,   0
	...
	move EGG_BOMB,     EFFECT_NORMAL_HIT,        100, NORMAL,        80, 10,   0
	move LICK,         EFFECT_PARALYZE_HIT,       40, GHOST,        100, 20,  30
	...
	move SKULL_BASH,   EFFECT_SKULL_BASH,        130, STEEL,       100, 10,   0
	...
	move KINESIS,      EFFECT_ACCURACY_DOWN,       0, PSYCHIC_TYPE, 100, 15,   0
	...
	move BARRAGE,      EFFECT_MULTI_HIT,          20, NORMAL,        95, 20,   0
	...
	move FURY_SWIPES,  EFFECT_MULTI_HIT,          20, NORMAL,        90, 15,   0
	...
	move THIEF,        EFFECT_THIEF,              50, DARK,         100, 10, 100
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  25, GROUND,       100, 10, 100
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  70, WATER,         95, 10,  50
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,       100, 20,   0
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      100, ELECTRIC,      60,  5, 100
	...
	move DYNAMICPUNCH, EFFECT_CONFUSE_HIT,       100, FIGHTING,      60,  5, 100
	...
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      100, PSYCHIC_TYPE, 100, 15,   0
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   50, FIGHTING,     100, 15,  50
