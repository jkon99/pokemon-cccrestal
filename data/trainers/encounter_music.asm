...
; entries correspond to trainer classes (see constants/trainer_constants.asm)
	...
	db MUSIC_HIKER_ENCOUNTER		; JON
	db MUSIC_HIKER_ENCOUNTER		; ALEX
	db MUSIC_BEAUTY_ENCOUNTER		; ASH
	db MUSIC_HIKER_ENCOUNTER		; CONNOR
	db MUSIC_HIKER_ENCOUNTER		; FRANCIS
	db MUSIC_BEAUTY_ENCOUNTER		; GENNA
	db MUSIC_BEAUTY_ENCOUNTER		; LEX
	db MUSIC_HIKER_ENCOUNTER		; NAHOM
	db MUSIC_HIKER_ENCOUNTER		; NANDO
	db MUSIC_HIKER_ENCOUNTER		; QASIM
	db MUSIC_BEAUTY_ENCOUNTER		; QUINN
	db MUSIC_BEAUTY_ENCOUNTER		; TJ
	assert_table_length NUM_TRAINER_CLASSES + 1 ; +12 or add 12 to that variable when adding custom trainers
